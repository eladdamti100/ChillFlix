...
public class UserSettingsActivity extends AppCompatActivity {
    ...
    private void uploadAvatarFile(File file, User updatedUser) {
        ...
        RetrofitClient.getUploadApiService(this).uploadAvatar(body).enqueue(new Callback<UploadResponse>() {
            @Override
    ...
    private void saveChanges() {
        ...
        if (selectedFile != null) {
                uploadAvatarFile(selectedFile, updatedUser);
            } else {
