...
public class EditCategoryActivity extends AppCompatActivity {
    ...
    private void updateCategory() {
        ...
        apiService.updateCategory(selectedCategory.getId(), selectedCategory).enqueue(new Callback<>() {
            @Override
            public void onResponse(@NonNull Call<Category> call, @NonNull Response<Category> response) {
                if (response.isSuccessful()) {
                    ...
                    Toast.makeText(EditCategoryActivity.this, "Failed to update category: " + response.message(), Toast.LENGTH_SHORT).show();
                }
            }
