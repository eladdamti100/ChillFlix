...
void DataManagement::updateUserMoviesFile(int userID) {
    try {
...
unordered_set<int> DataManagement::getUserMovies(int userID) const {
...
const map<int, unordered_set<int>>& DataManagement::getAllUsersMovies() const {
